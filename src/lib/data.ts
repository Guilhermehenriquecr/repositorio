...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    summary:
      "Plataforma de desdobramento de metas comerciais por praça e vendedor com base em dados de mercado, aplicando pesquisa operacional e modelos de otimização para balanceamento estratégico do mix de sementes. Inclui motor de scoring, simulador de cenários, mapa interativo, pipeline ETL e rotinas de otimização para distribuição de metas e maximização de eficiência comercial.",
    description:
      "Solução full-stack com motor de otimização para desdobramento de metas por praça e vendedor: distribui cotas por produto/região de forma balanceada via modelos de PO, acompanha realizado vs. planejado e classifica automaticamente cada representante por hit rate, aderência ao mix e desvio de portfólio.",
    longDescription:
      "Plataforma que aplica pesquisa operacional e modelos de otimização para distribuir metas comerciais de forma estratégica entre praças e vendedores, considerando potencial de mercado por região e balanceamento do mix de produtos. Inclui motor de scoring proprietário, simulador de cenários com recálculo instantâneo de volume e market share, pipeline ETL automatizado com normalização de dados e regras de negócio, mapa interativo com progresso por município e rotinas de otimização para maximização da eficiência comercial.",
    tags: ["Next.js", "TypeScript", "Python", "Docker", "Dados", "ETL", "Otimização"],
    icon: "📈",
    color: "#6A1B9A",
    gradient: "from-purple-900 to-purple-700",
    highlights: [
      "Rotinas de otimização (PO) para desdobramento e balanceamento estratégico do mix de metas por praça e vendedor",
      "Motor de scoring proprietário: hit rate, aderência ao mix e desvio de portfólio",
      "Simulador de cenários com recálculo instantâneo de volume, market share e eficiência comercial",
  ...
  {
    id: "soja-clima",
    title: "Plataforma de Inteligência Logística e Climática",
    subtitle: "Gestão de carteira comercial com previsão climática e IA",
    summary:
