...
function SkillTag({ name }: { name: string }) {
  return (
    <span className="inline-block px-3 py-1.5 rounded-lg text-xs font-medium bg-white/5 border border-white/10 text-slate-300 hover:text-white hover:border-white/20 transition-colors cursor-default">
      {name}
    </span>
  );
}
