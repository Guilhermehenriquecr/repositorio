          ...
          >
            <div className="glass rounded-2xl p-6 space-y-5">
              ...
              <a
                ...
                className="flex items-center gap-4 group"
              >
                <div className="w-10 h-10 rounded-xl bg-slate-500/10 border border-slate-500/20 flex items-center justify-center group-hover:border-slate-400/40 transition-colors">
                  <Github className="w-4 h-4 text-slate-400" />
                </div>
                <div>
                  <p className="text-xs text-slate-500 mb-0.5">GitHub</p>
                  <p className="text-sm text-slate-300 group-hover:text-white transition-colors">
                    github.com/guilherme-resende
                  </p>
                </div>
              </a>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-300">Brasil</p>
                </div>
              </div>
            </div>
