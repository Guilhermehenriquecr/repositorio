        ...
        <FadeIn>
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 text-lg max-w-2xl mx-auto leading-relaxed">
              <span className="text-white font-medium">Engenheiro de Produção</span>,
              <span className="text-violet-400 font-medium"> mestrando em Otimização</span> e
              com <span className="text-sky-400 font-medium">MBA em andamento em Pesquisa Operacional</span>
              {" "}e Tomada de Decisão pela <span className="text-white font-medium">Universidade Estadual do Vale do Acaraú (UVA)</span>.
            </p>
          </div>
        </FadeIn>
